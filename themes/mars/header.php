...
<div id="bg">
    ...
    <div id="pages">
		...
		if (function_exists('wp_nav_menu')) {		
            $primaryNav = wp_nav_menu( array( 'link_after'=>'<div class="cDivDivider" style="height: 36px;width: 1px;border-left: 1px solid white;display: inline;float: right;margin-top: -7px;"></div>','theme_location' => 'primary-menu', 'container' => '', 'fallback_cb' => '', 'menu_class' => $menuClass, 'echo' => false ) );
		}
