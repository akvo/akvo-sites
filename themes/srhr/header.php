...
<div id="iDivPatternHolder">
    <div id="iDivHeaderWhiteBg"></div>
<div id="bg">

<div class="cDivBodyWrapper">

  <div class="cDivHeaderWrapper">
     <div class="cDivHeaderWrapperInner">
...
<!--                    <br style="clear:both;" />-->
    ...
    <div id="wrapper2">
	<div class="cDivMenuWrapper">
	    <div class="cDivMenuWrapperInner">
		<div id="categories">
