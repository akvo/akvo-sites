...
<?php if ($dm_settings['show_postmeta'] != 0) : ?>
    <p class="text-right">
        ...
        <span class="glyphicon glyphicon-edit"></span> <?php edit_post_link(__('Edit','akvoblocksbootstrap3')); ?>
    </p>
    <p class="text-right"><span class="glyphicon glyphicon-circle-arrow-right"></span> <?php _e('Posted In','akvoblocksbootstrap3'); ?>: <?php the_category(', '); ?></p>
    <?php if( has_tag() ) : ?>
