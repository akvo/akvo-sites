...
?>
            <div id="iDivBlogPosts">
				...
				foreach($aPostTags AS $oTag)$aPostTagNames[]=$oTag->name;
                                    ...
                                    $sReadMoreLink = "http://ifad.akvoapp.org/rsr/project/";
...
//                                    continue;
								...
								<li class="cLiBlogPost <?php echo $sNoImgClass; ?>" rel="<?php echo $sCategory; ?>" posttype="<?php echo $post->post_type; ?>">
									...
									<div class="cDivReadmore">
										<a href="<?php echo $sReadMoreLink; ?>" rel="bookmark" title="<?php printf(esc_attr__('Permanent Link to %s', 'Quadro'), the_title()) ?>"><?php esc_html_e('More', 'Quadro'); ?></a>
									</div>
                                    <br style="clear:both;" />
								</li>
							<?php
