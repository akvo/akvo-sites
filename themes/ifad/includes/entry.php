...
if($sImgSrc=='')$sImgSrc='/wp-content/themes/ifad/images/placeholder.jpg';
...
<li class="cLiBlogPost <?php echo $sNoImgClass; ?>">
    ...
    <div class="cDivReadmore">
        <a href="<?php echo $sReadMoreLink; ?>" rel="bookmark" title="<?php printf(esc_attr__('Permanent Link to %s', 'Quadro'), $title) ?>"><?php esc_html_e('More', 'Quadro'); ?></a>
    </div>
    <br style="clear:both;" />
</li>