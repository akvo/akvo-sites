...
<div id="bg">
    ...
    <!--					<p id="iPSearch">-->
                        ...
                        <input type="image" class="input" src="<?php bloginfo('template_directory'); ?>/images/search-<?php echo esc_attr(get_option('quadro_color_scheme')); ?>.gif" value="submit"/>
    <!--					</p>-->
                    </form>
                </div> <!-- end #search -->
            </div> <!-- end #search-bg -->
    ...
    <div id="pages">
		...
		if (function_exists('wp_nav_menu')) {		
            $primaryNav = wp_nav_menu( array( 'link_after'=>'<div class="cDivDivider" style="height: 36px;width: 1px;border-left: 1px solid white;display: inline;float: right;margin-top: -7px;margin-left: 25px;"></div>','theme_location' => 'primary-menu', 'container' => '', 'fallback_cb' => '', 'menu_class' => $menuClass, 'echo' => false ) );
		}
