...
jQuery(document).ready(function($){
	...
	$et_learn_more.live('click', function() {
		if ( $(this).closest('.et_slidecontent').length ) {
            return;
        }
		...
		$(this).parents('.et-learn-more').find('.learn-more-content').animate({ opacity: 'toggle', height: 'toggle' }, 300, function(){
			var et_hidden_div_height,$et_hidden_tabs = $(this).find('.et-tabs-content,.et-simple-slides');
