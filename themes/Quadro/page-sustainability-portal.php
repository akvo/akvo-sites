...
//                    var_dump($oHeaderImage);
            ...
            <?php if($sBlue): ?>
            <div class="cDivBlueBlock"><h1><?php the_title(); ?></h1><?php echo $sBlue; ?></div>
            <?php endif; ?>
            <?php if($sExplanation): ?>
...
<?php get_footer(); ?>
    ...
    <script type="text/javascript" src="<?php echo get_template_directory_uri();?>/js/wiel/wiel.js"></script>
