	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				  ...
				  "options" => array("Red", "Purple", "Green", "Blue", "Pink")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Show Tabbed Area on Homepage",
                   "id" => $shortname."_show_tabs",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc."),
				  
			array( "name" => "Show Recent Entries Area",
                   "id" => $shortname."_show_tabarea_recententries",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "desc."),	  
			...
			array( "name" => "Show Popular Area",
                   "id" => $shortname."_show_tabarea_popular",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc."),
				   
			array( "name" => "Show Recent Comments Area",
                   "id" => $shortname."_show_tabarea_recentcomments",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "desc."),
			...
			array( "name" => "Recent posts number",
				   "id" => $shortname."_recentposts_num",
				   "type" => "text",
				   "std" => "6",
				   "desc" => "desc.",),

			array( "name" => "Popular posts number",
				   "id" => $shortname."_popular_posts_num",
				   "type" => "text",
				   "std" => "6",
				   "desc" => "desc.",),			
						
			array( "name" => "Recent comments number",
				   "id" => $shortname."_recentcomments_num",
				   "type" => "text",
				   "std" => "6",
				   "desc" => "desc.",),	
		...
		array( "name" => "general-3",
			...
			array( "name" => "Display Featured Articles",
			...
			array( "name" => "Number of Featured Articles",
...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#left-div a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		#pages li a:link, #pages li a:visited, #categories li a:link, #categories li a:visited { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		#pages li a:hover, #pages li a:active, #categories li a:hover, #categories li a:active { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
