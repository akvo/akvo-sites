<?php 
/*
Template Name: Funding partners Page
*/
?>
<?php
		...
		<div id="left-div">
            ...
            <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				<div class="post-wrapper <?php if($fullwidth) echo (' no_sidebar"');?>">
                    ...
                    if($thumb){
                        ?>
                    <div style="float: left; margin: 10px 10px 10px 0px;width:30%;">
                        <img src="<?php echo $thumb; ?>" style="width:100%" />
                    </div>
                    <?php
                    }else{
                    ?>
						...
						<?php if($thumb <> '') { ?>
							<div style="float: left; width:30%; margin: 10px 10px 10px 0px;">
								<?php print_thumbnail($thumb, $thumbnail["use_timthumb"], $titletext , $width, $height, $classtext); ?>
							</div>
						<?php }; ?>
                    <?php } ?>	
