...
//	}
	...
	public function buildURL($sURLFor, $iOrgID = '') {		
		...
		switch($sURLFor) {
			case 'projects':
				...
				$sParams .= '&partners='. $iOrgID;
				break;
			case 'project_map_locations':
				$sAPIURL = self::API_PROJECT_MAP_LOCATION;
				$sParams .= '&location_target__partners='. $iOrgID;
				break;
...
//	}
	...
	public function getProjectLocationData() {
	...
	public function getProjectData($sFields) {
