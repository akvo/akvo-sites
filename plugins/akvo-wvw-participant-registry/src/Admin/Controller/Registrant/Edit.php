...
//		$aContent = $oRegistry->getRegistrant();
		...
		include_once AkvoWvwParticipantRegistry_Plugin_Dir . '/src/Admin/View/scripts/registrant/edit.phtml';

	}

	public function enqueueBootstrapDatePickerJs () {

		wp_register_script('twitter_bootstrap_date_picker_js', AkvoWvwParticipantRegistry_Plugin_Url . '/assets/plugins/bootstrap_datepicker/js/bootstrap-datepicker.js');
		wp_enqueue_script('twitter_bootstrap_date_picker_js');

		wp_register_script('twitter_bootstrap_date_picker_en_js', AkvoWvwParticipantRegistry_Plugin_Url . '/assets/plugins/bootstrap_datepicker/js/locales/bootstrap-datepicker.nl.js');
	...
	public function enqueueBootstrapDatePickerCss () {
		...
		wp_register_style('twitter_bootstrap_date_picker_css', AkvoWvwParticipantRegistry_Plugin_Url . '/assets/plugins/bootstrap_datepicker/css/datepicker.css');
