...
class Settings extends Base {
	...
	public function page () {
		...
		$oSettings = new \Akvo\WvW\ParticipantRegistry\Admin\Model\Settings();
		$aContent = $oSettings->manage();

		include_once AkvoWvwParticipantRegistry_Plugin_Dir . '/src/Admin/View/scripts/settings/settings.phtml';
