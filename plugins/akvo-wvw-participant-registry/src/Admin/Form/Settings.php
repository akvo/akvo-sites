<?php
namespace Akvo\WvW\ParticipantRegistry\Admin\Form;
	...
	public function init() {
		...
		switch ($this->_sContext) {
			...
			case self::CONTEXT_CREATE:
				...
				$oGoogleMapsDefaultCenterPointLatitude->addValidator('Float', true);
				$oGoogleMapsDefaultCenterPointLatitude->addValidator('Between', true, array('min' => -90, 'max' => 90));
				...
				$oGoogleMapsDefaultCenterPointLongitude->addValidator('Float', true);
				$oGoogleMapsDefaultCenterPointLongitude->addValidator('Between', true, array('min' => -180, 'max' => 180));
