...
class Controller {
	...
	public function initialise () {
		...
		register_activation_hook(AkvoWvwParticipantRegistry_Plugin_File, array('Akvo\WvW\ParticipantRegistry\Controller', 'doActivation'));
		register_deactivation_hook(AkvoWvwParticipantRegistry_Plugin_File, array('Akvo\WvW\ParticipantRegistry\Controller', 'doDeactivation'));
		register_uninstall_hook(AkvoWvwParticipantRegistry_Plugin_File, array('Akvo\WvW\ParticipantRegistry\Controller', 'doUninstall'));
		add_action('activated_plugin', array('Akvo\WvW\ParticipantRegistry\Controller', 'setToLoadLast'));
	...
	private function _initForms () {
		...
		$aTranslations = require_once AkvoWvwParticipantRegistry_Plugin_Dir . '/resources/Zend/languages/nl/Zend_Validate.php';
...
//		$oDaoRegister->deleteTable();
		...
		get_role("administrator")->add_cap(\Akvo\WvW\ParticipantRegistry\Config::CAPABILITY_GENERAL_NAME);
		get_role("editor")->add_cap(\Akvo\WvW\ParticipantRegistry\Config::CAPABILITY_GENERAL_NAME);

	}

	public static function doDeactivation () {

		get_role("administrator")->remove_cap(\Akvo\WvW\ParticipantRegistry\Config::CAPABILITY_GENERAL_NAME);
		get_role("editor")->remove_cap(\Akvo\WvW\ParticipantRegistry\Config::CAPABILITY_GENERAL_NAME);
	...
	public static function setToLoadLast () {
		...
		$sThisPluginFile = AkvoWvwParticipantRegistry_Plugin_DirFile;
