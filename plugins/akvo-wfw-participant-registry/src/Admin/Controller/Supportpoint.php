...
class Supportpoint extends Base {
	...
	public function page () {
		...
		$oModel = new \Akvo\WfW\ParticipantRegistry\Admin\Model\Supportpoint();
		$aContent = $oModel->manage();

		include_once AkvoWfwParticipantRegistry_Plugin_Dir . '/src/Admin/View/scripts/supportpoint/index.phtml';
